...
\begin{tabularx}{10cm}{c l c}
\toprule
Variable & Description & Value \\
\midrule
\(P_T\) & transmitted power & ? dBm \\
\(G\) & antenna gain & \(\SI{14}{dB}\) \\
\(\lambda\) & wavelength & \(\SI{5.4}{cm}\) \\
\(\sigma\) & cross-sectional area & \(\SI{1}{m^2}\) \\
\(P_{R_{min}}\) & minimum-detectable received power & ? dBm \\
\bottomrule
\end{tabularx}

See the [[id:75195f2c-0743-4694-bd4a-a6e3d34b42aa][transmitter]] and [[id:5b91918a-80ec-4cff-af24-e620558c087a][receiver]] sections for how the transmitted
power, antenna gain, and minimum-detectable received power were
determined.
...
therefore distortion. We can work back from this value to determine
