...
\fixme{I think pinout sections would be better placed in an appendix, with dual links from the
  component documentation to the pinout and from the pinout back to the documentation.}
