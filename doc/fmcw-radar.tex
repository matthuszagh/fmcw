...
must be added back in to the original result to get the true distance. \fixme{How can I track an
...
\fixme{This is calculated by Henrik on his blog post. I don't quite understand the part about FFT
  length. Maybe this will make more sense after writing the FPGA code.}

\section{Angle Calculation}
\label{sec:angle}

\fixme{This must be filled in.}
