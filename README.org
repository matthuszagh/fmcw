...
Henrik's. Additionally, there are a few parts of my writeup that
address similar topics to those discussed by Henrik. I've made
attribution where necessary. Despite the fact that Henrik deserves
most of the credit for this project, he is in no way affiliated with
this fork.

This project is still in its early stages. Expect bugs.
